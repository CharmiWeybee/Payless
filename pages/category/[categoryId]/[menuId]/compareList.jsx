...
import { useGetCompareDataQuery } from "../../../../redux/api/Food/foodApi";
...
function Compare() {
  ...
  const { data: data, isLoading: menuLoading } = useGetCompareDataQuery(
    categoryId,
    menuId,
    { skip }
  );
  ...
  console.log(menuId,categoryId, menuData)
  ...
  return (
    <>
      <Menu />
      {menuData && menuData.length == 0 || !menuData ? (
          ...
          <div className="comparison-container">
            <section className="">
              ...
              <div className="row comparison-cards mt-5">
                {menuData && menuData[0]?.sourceList && 
